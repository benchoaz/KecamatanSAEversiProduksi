...
@section('breadcrumb', 'Kesra / Data Kesra')
            ...
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-title fw-bold text-primary-900">
                        <i class="fas fa-hands-helping text-brand-600 me-2"></i>
                        Data Kesejahteraan Sosial
                    </h1>
                    <p class="text-secondary mt-1 mb-0">Kelola dan pantau data kesejahteraan sosial desa</p>
                </div>
                <div class="col-auto">
                    <a href="{{ route('desa.kesra.create') }}" class="btn btn-brand shadow-sm">
            ...
            <div class="card-body p-4">
                @if($submissions->isEmpty())
                    <div class="text-center py-5">
                        ...
                        <h5 class="text-muted mt-3">Belum Ada Data Kesra</h5>
                        <p class="text-secondary">Mulai dengan menambahkan data kesejahteraan sosial pertama Anda.</p>
                        <a href="{{ route('desa.kesra.create') }}" class="btn btn-brand mt-2">
                            <i class="fas fa-plus me-2"></i>Tambah Data Baru
                        </a>
                    </div>
                @else
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('desa.kesra.show', $submission->id) }}"
                                                    class="btn btn-sm btn-outline-primary" title="Lihat Detail">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                @if($submission->status === 'draft')
                                                    <a href="{{ route('desa.kesra.edit', $submission->id) }}"
                                                        class="btn btn-sm btn-outline-warning" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('desa.kesra.destroy', $submission->id) }}" method="POST"
