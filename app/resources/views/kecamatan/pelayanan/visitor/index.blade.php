    ...
    <div class="content-header mb-5">
        <div class="d-flex align-items-center gap-2 mb-2">
            <a href="{{ route('dashboard') }}"
                ...
                <i class="fas fa-arrow-left-long me-2"></i> Kembali ke Dashboard
            </a>
        </div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-premium rounded-4 h-100 overflow-hidden">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('kecamatan.pelayanan.visitor.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        @if($visitor->status != 'selesai')
                                            <form action="{{ route('kecamatan.pelayanan.visitor.update', $visitor->id) }}"
