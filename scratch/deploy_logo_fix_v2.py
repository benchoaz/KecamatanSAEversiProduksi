...
os.system("git add .")
os.system("git commit -m 'Force logo transparency in master layout'")
os.system("git push origin main")

print("--- Pulling on VPS ---")
print(run_ssh_cmd("cd /home/ubuntu/kecamatanSAE && git pull origin main"))

print("--- Force Copying Updated Layout to Container ---")
src = "/home/ubuntu/kecamatanSAE/app/resources/views/layouts/kecamatan.blade.php"
dest = "kecamatan-app:/var/www/resources/views/layouts/kecamatan.blade.php"
