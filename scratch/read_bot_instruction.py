...
print("=" * 60)
print("READING AI BOT INSTRUCTION")
print("=" * 60)
sql_cmd = "cd kecamatanSAE && docker compose exec -T db psql -U user -d dashboard_kecamatan -c \"SELECT ai_bot_instruction FROM app_profiles LIMIT 1;\""
